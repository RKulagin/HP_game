...
class GameObject {
public:
  enum class Tag { Unknown, Player, Enemy,
    PlayerBullet, EnemyBullet ,Ally, Train, Dragon, Orc, Magician, TextBox };
  enum class GameState { Menu, Introduction, Action, Epilogue, GameOver, WaitingInput};
